...
(function ($) {
  var FormBuilder = function FormBuilder(options, element) {
    ...
    var defaults = {
      ...
      disableFields: ['autocomplete', 'button', 'checkbox', 'checkbox-group', 'date', 'file', 'hidden', 'number', 'select'],
      editOnAdd: true,
      ...
      messages: {
        ...
        allFieldsRemoved: 'Tous les champs ont ete supprimes.',
        allowSelect: 'Autoriser la selection',
        allowMultipleFiles: 'Autoriser chargement multiple de fichiers',
        autocomplete: 'Autocompletion',
        button: 'Bouton',
        cannotBeEmpty: 'Ca champ ne peut pas etre vide',
        checkboxGroup: 'Groupe de cases a cocher',
        checkbox: 'Case a cocher',
        checkboxes: 'Cases a cocher',
        className: 'Classe',
        clearAllMessage: 'Etes-vous sur de vouloir supprimer tous les elements?',
        clearAll: 'Vider',
        close: 'Fermer',
        content: 'Contenu',
        ...
        editorTitle: 'Elements du formulaire',
        editXML: 'Edition XML',
        enableOther: 'Autoriser \'autres\'',
        enableOtherMsg: 'Permettre les utilisateurs d\'ajouter une option non listee',
        fieldDeleteWarning: false,
        fieldVars: 'Variables champs',
        fieldNonEditable: 'Ce champ ne peut pas etre edite',
        fieldRemoveWarning: 'Etes-vous sur de vouloir supprimer ce champ?',
        fileUpload: 'Chargement fichier',
        formUpdated: 'Chargement formulaire',
        getStarted: 'Glisser-deposer un element de la liste vers cette zone.',
        header: 'Titre',
        hide: 'Cacher',
        hidden: 'Champ cache',
        label: 'Libelle',
        labelEmpty: 'Un libelle ne peut etre vide',
        limitRole: 'Limiter l\'acces a un ou plusieurs des roles suivants:',
        mandatory: 'Obligatoire',
        maxlength: 'Longueur maximale',
        minOptionMessage: 'Ca champ requiers au moins deux options',
        multipleFiles: 'Fichiers mutliples',
        name: 'Nom',
        no: 'No',
        number: 'Numero',
        off: 'Off',
        ...
        option: 'Option',
        optional: 'optionnel',
        optionLabelPlaceholder: 'Libelle',
        optionValuePlaceholder: 'Valeur',
        optionEmpty: 'Valeur d\'option requis',
        other: 'Autre',
        paragraph: 'Question ?',
        ...
        placeholders: {
          ...
          placeholder: 'espace reserve',
          className: 'classes separe par un espace',
          password: 'Votre mot de passe'
        },
        preview: 'Apercu',
        radioGroup: 'Evaluation',
        radio: 'Element d\'evaluation',
        ...
        selectionsMessage: 'Autoriser multiple selections',
        size: 'Taille',
        sizes: {
          xs: 'Extra Small',
          sm: 'Small',
    ...
    var frmbFields = [{
      ...
      attrs: {
        type: 'paragraph',
        className: 'fbParagraph'
      }
    }, {
      label: opts.messages.radioGroup,
      attrs: {
        type: 'radio-group',
        className: 'fbRadioGroup',
        name: 'radio-group'
      }
    }, {
...
//          formActions = utils.markup('div', [clearAll, viewData, saveAll], {
    ...
    var fieldOptions = function fieldOptions(values) {
      ...
      if (!values.values || !values.values.length) {
        values.values = [1, 2, 3, 4, 5].map(function (index) {
          var label = /*opts.messages.option + ' ' +*/ 'valeur ' + index;
          var option = {
            selected: false,
            label: label,
            value: /*utils.hyphenCase(label)*/ index
          };
          return option;
        });
