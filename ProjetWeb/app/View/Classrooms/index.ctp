<div class="classrooms index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $classroom['Classroom']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $classroom['Classroom']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
