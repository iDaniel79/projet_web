...
--
-- Client :  127.0.0.1
-- Généré le :  Sam 10 Décembre 2016 à 19:37
...
--
CREATE DATABASE IF NOT EXISTS `db_formulaires` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `db_formulaires`;
...
INSERT INTO `formulaires` (`id`, `version`, `name`, `titre_1`, `titre_2`, `titre_3`, `titre_4`, `titre_5`, `titre_6`, `titre_7`, `token_length`, `scribe_check`, `directeur_check`, `verif_check`) VALUES
