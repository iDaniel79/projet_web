...
-- -----------------------------------------------------
-- Table `db_formulaires`.`sections`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db_formulaires`.`sections` ;

CREATE TABLE IF NOT EXISTS `db_formulaires`.`sections` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `db_formulaires`.`users` (
  ...
  INDEX `fk_users_sections1_idx` (`sections_id` ASC),
  ...
  CONSTRAINT `fk_users_sections1`
    ...
    REFERENCES `db_formulaires`.`sections` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
