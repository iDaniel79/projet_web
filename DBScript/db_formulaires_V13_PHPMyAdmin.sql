...
--
-- Client :  127.0.0.1
-- Généré le :  Dim 11 Décembre 2016 à 18:11
...
CREATE TABLE IF NOT EXISTS `formreturns` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `roles_zones` (
...
CREATE TABLE IF NOT EXISTS `users_ufs` (
  `user_id` int(11) NOT NULL,
